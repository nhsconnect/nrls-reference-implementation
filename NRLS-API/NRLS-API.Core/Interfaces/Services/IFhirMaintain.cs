...
namespace NRLS_API.Core.Interfaces.Services
{
    public interface IFhirMaintain
    {
        ...
        SystemTasks.Task<(Resource created, bool updated)> CreateWithUpdate<T>(FhirRequest request, FhirRequest updateRequest, UpdateDefinition<BsonDocument> updates) where T : Resource;
